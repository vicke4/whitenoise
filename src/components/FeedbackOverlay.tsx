...
const FeedbackOverlay = ({
  ...
  return (
    ...
    >
      <div className="text-4xl md:text-5xl font-bold tracking-wider text-white drop-shadow-2xl bg-slate-950/30 backdrop-blur-sm px-6 py-2 rounded-2xl border border-white/10">
        {feedbackText}
      </div>
      {timerDuration > 0 && (
